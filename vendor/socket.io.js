...
/**
 * This is the common logic for both the Node.vendor and web browser
...
;(function(root) {
	...
	// Detect free variable `global`, from Node.vendor or Browserified code,
	// and use it as `root`
	...
	// Some AMD build optimizers, like r.vendor, check for specific condition patterns
	// like the following:
	if (
		...
		if (freeModule) { // in Node.vendor or RingoJS v0.8.0+
 ...
 *
 *   - https://github.com/Modernizr/Modernizr/blob/master/feature-detects/cors.vendor
 */
...
;(function (window) {
  ...
  // strict `define` check is necessary for compatibility with `r.vendor`.
